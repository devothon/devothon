...
<p align="center">
  Me chamo <strong>Othon</strong>, tenho 18 anos e moro em <strong>Belo Horizonte - MG</strong>.
</p>

<div align="left">
🎓 <strong>Estudante da área de Tecnologia da Informação</strong><br>
📘 Técnico em <strong>Análise e Desenvolvimento de Sistemas</strong> pelo <strong>SENAI CTTI</strong><br>
💡 Apaixonado por tecnologia, lógica e resolução de problemas<br>
🚀 Sempre em busca de aprendizado contínuo e evolução profissional
</div>
...
- ✨ Busco unir **precisão técnica, pensamento lógico e criatividade** em soluções reais

Atualmente, estou aberto a **oportunidades de estágio**, desafios em TI e conexões profissionais que possibilitem crescimento e colaboração em projetos de impacto.
